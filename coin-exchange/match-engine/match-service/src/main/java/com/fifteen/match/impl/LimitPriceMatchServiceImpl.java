package com.fifteen.match.impl;

import com.fifteen.domain.ExchangeTrade;
import com.fifteen.enums.OrderDirection;
import com.fifteen.match.MatchService;
import com.fifteen.match.MatchServiceFactory;
import com.fifteen.match.MatchStrategy;
import com.fifteen.model.MergeOrder;
import com.fifteen.model.Order;
import com.fifteen.model.OrderBooks;
import com.fifteen.model.TradePlate;
import com.fifteen.rocket.Source;
...
public class LimitPriceMatchServiceImpl implements MatchService, InitializingBean {
    ...
    private ExchangeTrade processMath(Order taker, Order marker, OrderBooks orderBooks) {
        ...
        taker.setTurnover(taker.getTurnover().add(turnoverTaker));
